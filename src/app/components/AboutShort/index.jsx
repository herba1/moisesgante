...
export default function AboutShort({ data }) {
  return (
    <div className="aboutShort__container">
      ...
      <div className="aboutShort__wrapper grid grid-cols-2 gap-x-small">
        <div className=" flex flex-col gap-small">
          <Subtitle text={data.name}></Subtitle>
          <ParagraphAnimated className={'xl:text-lg'}>{data.briefDescription}</ParagraphAnimated>
          <MaskButton
        ...
        <Accordion data={data.qna} title="What about me?" ></Accordion>
      </div>
    </div>
  );
}
